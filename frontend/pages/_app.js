...
function MyApp({ Component, pageProps }) {
    return (
        <div className={`${poppins_init.variable} ${kode_mono_init.variable} ${lekton_init.variable} ${climate_crisis_init.variable} ${chakra_petch_init.variable} ${quantico_init.variable} antialiased`}>
          <main>
            <Component {...pageProps} />
          </main>
        </div>
